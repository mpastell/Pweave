...
class PwebFormats(object):
    ...
    formats = {
        ...
        "markdown": {
            "class": PwebPandocFormatter,
            "description": "Pandoc markdown, same as format pandoc",
        },
