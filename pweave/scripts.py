...
# Command line options
    ...
    parser.add_option("-s", "--shell", dest="shell", default='python',
                      help="shell used to run code: python, epython (external python shell) or ipython")
    ...
    #pweave.weave(infile, doctype = options.format, informat=options.informat, shell=options.shell, shell_path=options.shell_path, plot = mplotlib,
